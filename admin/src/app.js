...
(0, typeorm_1.createConnection)().then(function (db) {
    //kết nối rabbitmq
    amqp.connect('amqps://vgqbdzaf:lA2tKR2ll9KvGKHC81QoPzKaWGAnKXlF@roedeer.rmq.cloudamqp.com/vgqbdzaf', function (err, conn) {
        if (err) {
            throw err;
        }
        conn.createChannel(function (error, channel) {
            ...
            //increse like 
            app.get('/api/product/:id/like', function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
                var product, result;
                return __generator(this, function (_a) {
                    switch (_a.label) {
                        case 0: return [4 /*yield*/, productRepository.findOneBy({ id: parseInt(req.params.id) })];
